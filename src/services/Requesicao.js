...
export default function App() {
  ...
  async function getDados() {
    try {
      ...
      const response = await axios.get(`https://hn.algolia.com/api/v1/search/?query=tags=author_:${buscaText}`);
      //BUSCA POR UM AUTOR ESPECIFIO: https://hn.algolia.com/api/v1/search/?query=tags=author_:${buscaText}
      setBuscaText([])
